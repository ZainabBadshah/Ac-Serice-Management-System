...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Technicians</h3>
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `technician_list` order by (`name`) asc ");
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this technician permanently?","delete_mechanic",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
